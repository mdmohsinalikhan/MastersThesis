...
plt.title('$T_a(\phi)$ for where $a=0,|\phi|=2048$ using 10000 different samples')
plt.text(5,.070,r'using $15$ rounds of SMALLPRESENT-4 with all zero key')
plt.text(5, .065, r'$\mu=23.19, \sigma^2=62.78$ for the theoretical plot in red line')
