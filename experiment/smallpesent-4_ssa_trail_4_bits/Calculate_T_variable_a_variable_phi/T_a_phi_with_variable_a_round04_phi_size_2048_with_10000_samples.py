...
with open('T_a_phi_variable_a_variable_phi_04_round.txt') as f:
    array = []
    for line in f:
        data = line.split()
...
plt.text(20,.070,r'using $04$ rounds of SMALLPRESENT-[$4$] with all zero key')
...
plt.text(20, .055, r'$\mu=32.35, \sigma^2=139.57$ for the theoretical plot in blue line')
