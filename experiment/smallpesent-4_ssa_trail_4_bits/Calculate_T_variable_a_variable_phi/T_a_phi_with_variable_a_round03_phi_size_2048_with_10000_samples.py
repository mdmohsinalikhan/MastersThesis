...
with open('T_a_phi_variable_a_variable_phi_03_round.txt') as f:
    array = []
    for line in f:
        data = line.split()
...
plt.text(20,.070,r'using $03$ rounds of SMALLPRESENT-[$4$] with all zero key')
...
plt.text(20, .055, r'$\mu=68.90, \sigma^2=633.02$ for the theoretical distribution in blue line')
