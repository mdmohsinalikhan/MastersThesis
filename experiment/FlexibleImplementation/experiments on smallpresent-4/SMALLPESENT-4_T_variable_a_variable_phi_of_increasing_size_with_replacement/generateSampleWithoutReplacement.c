...
unsigned long long int* generateSampleWithoutreplacement()
{
	...
	/*Here we are ensuring that the sample is with replacement. If we change the index of sample_plaintext_set_local array from 0 to 1
	  then it will be sample without replacement*/
	for(i = 0; i < samplesize; i++)
	{
